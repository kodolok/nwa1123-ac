        ...
        unsigned long arg)
{
    ...
    static unsigned int watchtime = ATH_DEFAULT_WDT;
    static unsigned int WdtStatus = ATH_WD_ACT_NONE;
    ...
    case WDIOC_GETSTATUS :
        put_user(WdtStatus, (int *)arg);
        break;
    case WDIOC_SETOPTIONS:
        WdtStatus = ATH_WD_ACT_NONE;
        ath_set_wd_timer_action(WdtStatus);
       /* printk("WDIOC_SETOPTIONS \r\n");*/
        break;
    case WDIOC_SETTIMEOUT:
        WdtStatus = ATH_WD_ACT_RESET;
        ret = get_user(watchtime, (int *)arg);
      //  printk("\r\WDIOC_SETTIMEOUT1 :%d\r\n",watchtime);
        if(ret){
      //  printk("\r\WDIOC_SETTIMEOUT2 :%d\r\n",watchtime);
            break;
        }
        ath_set_wd_timer(watchtime*USEC_PER_SEC*10);
        ath_set_wd_timer_action(WdtStatus);
      //   printk("\r\WDIOC_SETTIMEOUT3 :%d\r\n",watchtime);
        break;
        ...
        ath_set_wd_timer(watchtime*USEC_PER_SEC*10);
        ath_set_wd_timer_action(WdtStatus);
      //  printk("\r\WDIOC_KEEPALIVE :%d\r\n",watchtime);
        break;
    case WDIOC_GETTIMEOUT:
        //watchtime = ath_get_wd_timer();
        put_user(watchtime, (int *)arg);
        //printk("\r\WDIOC_GETTIMEOUT\r\n");
        break;
