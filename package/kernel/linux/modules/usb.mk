...
define KernelPackage/usb-core
  ...
  ifneq ($(wildcard $(LINUX_DIR)/drivers/usb/usb-common.ko),)
  FILES:= \
...
define KernelPackage/usb-dwc3
  ...
  AUTOLOAD:=$(call AutoLoad,53,dwc3,1)
  $(call AddDepends/usb)
endef
...
define KernelPackage/usb-dwc3-ipq
  TITLE:=DWC3 USB IPQ controller driver
  KCONFIG:=CONFIG_USB_DWC3_IPQ
  FILES:=$(LINUX_DIR)/drivers/usb/dwc3/dwc3-ipq.ko
  AUTOLOAD:=$(call AutoLoad,53,dwc3-ipq,1)
  DEPENDS:=@TARGET_ipq806x +kmod-usb-dwc3
  $(call AddDepends/usb)
endef

define KernelPackage/usb-dwc3-ipq/description
 This driver provides support for the integrated DesignWare
 USB3 IP Core within the IPQ SoCs.
endef

$(eval $(call KernelPackage,usb-dwc3-ipq))
...
define KernelPackage/usb-wdm
  ...
  AUTOLOAD:=$(call AutoLoad,67,cdc-wdm)
$(call AddDepends/usb)
...
define KernelPackage/usb-serial-qualcomm
  ...
  AUTOLOAD:=$(call AutoLoad,69,qcserial)
  $(call AddDepends/usb-serial,+kmod-usb-serial-wwan)
endef
