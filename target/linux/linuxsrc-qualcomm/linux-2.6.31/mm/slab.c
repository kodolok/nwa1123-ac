...
extern void __kmalloc_account_priv(const void *caller, const void *addr, int size, int req);
void __kmalloc_account(const void *caller, const void *addr, int size, int req) {
	__kmalloc_account_priv(caller,addr,size,req);
}
EXPORT_SYMBOL(__kmalloc_account);
#endif
#endif
