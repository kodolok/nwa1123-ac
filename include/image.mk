...
IMG_PREFIX:=openwrt-ipq806x$(if $(SUBTARGET),-$(SUBTARGET))
else
IMG_PREFIX:=openwrt-$(TARGET_BOARD)$(if $(SUBTARGET),-$(SUBTARGET))
endif
endif
...
ifneq ($(CONFIG_TARGET_ROOTFS_INITRAMFS),)
  ...
  ifneq ($(CONFIG_TARGET_ROOTFS_SQUASHFS),)
    define Image/mkfs/squashfs
    		$(call Image/dni/firmwareinfo)
		$(call Image/BuildRootfs/squashfs)
		$(call Image/Build,squashfs)
		$(call Image/dni/firmware)
    endef
  endif
