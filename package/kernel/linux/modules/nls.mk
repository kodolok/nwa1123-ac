...
define KernelPackage/nls-base
  ...
  AUTOLOAD:=$(call AutoLoad,19,nls_base)
endef
...
define KernelPackage/nls-cp932/description
 Kernel module for NLS Codepage 932 (Japan)
endef
...
define KernelPackage/nls-cp860
  SUBMENU:=Native Language Support
  TITLE:=Codepage 860 (Portuguese)
  KCONFIG:=CONFIG_NLS_CODEPAGE_860
  FILES:=$(LINUX_DIR)/fs/nls/nls_cp860.ko
  AUTOLOAD:=$(call AutoLoad,25,nls_cp860)
  $(call AddDepends/nls)
endef

define KernelPackage/nls-cp860/description
 Kernel module for NLS Codepage 860 (Portuguese)
endef

$(eval $(call KernelPackage,nls-cp860))
